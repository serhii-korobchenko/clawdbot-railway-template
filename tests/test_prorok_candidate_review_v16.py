...
def make_db(path: Path) -> None:
    ...
    CREATE TABLE sources(source_id INTEGER PRIMARY KEY,url TEXT,canonical_url TEXT,canonical_url_hash TEXT UNIQUE,title TEXT,domain TEXT,publisher TEXT,published_at TEXT,accessed_at TEXT,first_seen_at TEXT,last_seen_at TEXT,source_type TEXT,raw_metadata TEXT);
